  ...
  Padding buildNextButton() {
    return Padding(
      ...
      child: SizedBox(
        ...
        child: Visibility(
          visible: _inProgress == false, // If _inProgress is false, it shows the button.
          replacement: const CenteredCircularProgressIndicator(), // If _inProgress is true, it shows a CenteredCircularProgressIndicator instead.
